...
const Hot = ({ hot }) => {
  return (
    <div className=" relative lg:h-[340px] list-none mt-[40px] border border-white bg-white lg:ml-[325px] lg:mr-[260px] w-[370px] lg:w-[1300px]md:w-[470px] lg:w-[1300px]">
      ...
      <div className="flex items-center mt-[60px] flex-wrap lg:w-[1270px] lg:ml-[80px] text-center ml-[90px] w-[100px]">
        ...
        <div className="w-[128px] h-[129px]  text-sm ml-[40px] font-bold">
          ...
          <li className="lg:w-[128px] lg:h-[39px] text-[15px] text-yellow-500 w-[100px]">
            {" "}
            Thẻ nhớ{" "}
          </li>
        </div>
        ...
        <div className="w-[128px] h-[129px]  text-sm ml-[90px] font-bold">
          ...
          <li className="lg:w-[128px] lg:h-[39px] text-orange-500 text-[15px] w-[100px]">
            {" "}
            Tai nghe{" "}
          </li>
        </div>
