    ...
    <div className="relative bg-[#252525] h-9 flex items-center list-none">
      <div className="flex items-center text-white absolute lg:ml-[310px] ml-1">
        ...
        <HtmlTooltip
          title={
            <React.Fragment>
              <div className="lg:w-[760px] flex border border-white bg-white">
                ...
                <div className="lg:ml-[30px] lg:mt-[20px]">
                ...
                <div className="lg:ml-[420px] absolute lg:w-[120px] lg:mt-[20px]">
                ...
                <div className="lg:ml-[230px]">
                  <div className="flex items-center">
                    <img
                      ...
                      alt=""
                      className="lg:w-[30px] lg:h-[30px] lg:mt-[20px]"
                    />
                    <div className="flex items-center list-none relative lg:ml-[10px]">
                      <li> Samsung Galaxy A22 5G </li>
                      <span className="absolute lg:top-[20px]">
                        {" "}
                        6.290.000 đ{" "}
                      </span>
                    </div>
                  </div>
                  <div className="list-none flex items-center lg:mt-[20px]">
                    <img
                      src="https://www.mobilebazar.com.bd/assets/img/Oppo-A55.jpg"
                      alt=""
                      className="lg:w-[30px] lg:h-[30px] lg:mt-[10px]"
                    />
                    <div className="lg:ml-[10px]">
                      <li> OPPO A55 4GB - 64GB </li>
                      <span className="absolute lg:top-[120px] lg:w-[100px]">
                        {" "}
                        4.990.000 đ{" "}
                      </span>
                    </div>
                  ...
                  <div>
                    <img
                      ...
                      alt=""
                      className="lg:w-[80px] lg:h-[80px] lg:mt-[25px] lg:ml-[10px]"
                    />
                  </div>
                </div>
              </div>
        ...
        >
          <li className="text-white lg:text-sm text-xs ml-2 mt-1 cursor-pointer">
            {" "}
            ĐIỆN THOẠI{" "}
          </li>
        </HtmlTooltip>
      ...
      <div className="flex items-center text-white absolute ml-28 lg:ml-[440px]">
        ...
        <HtmlTooltip
          title={
            <React.Fragment>
              <div className="lg:w-[700px] flex border border-white bg-white">
                <div className="lg:mt-[20px]">
                  <Typography color="inherit" className="lg:w-[200px]">
                    {" "}
                    HÃNG SẢN XUẤT{" "}
                  </Typography>
                  <div>
                ...
                <div className="lg:ml-[130px] lg:mt-[20px]">
                  <img
                  ...
                  />
                  <p className="text-center lg:mt-[20px] text-[16px] text-orange-500">
                    {" "}
                    Maccbook Air 13{" "}
                  </p>
                </div>
      ...
      <div className="flex items-center text-white absolute ml-[195px] lg:ml-[545px]">
              ...
              <div className="lg:w-[700px] flex border border-white bg-white">
                ...
                <div className="lg:ml-[30px] lg:mt-[20px]">
                  ...
                  <div className="list-none flex items-center lg:mt-[20px]">
                    ...
                    <div className="lg:ml-[10px]">
                      <li> OPPO A55 4GB - 64GB </li>
                      <span className="absolute lg:top-[160px] lg:w-[100px]">
                        {" "}
                        4.990.000 đ{" "}
                      </span>
                    </div>
                ...
                <div className="lg:ml-[130px] lg:mt-[20px]">
                  <img
                    ...
                    className="lg:w-[120px] lg:h-[120px] "
                  />
                  <p className="text-center lg:mt-[20px] lg:text-[16px] text-orange-500">
                    {" "}
                    Ipad Pro 11 M1{" "}
                  </p>
                </div>
        ...
        >
          <li className="text-white text-xs lg:text-sm ml-2 mt-1 cursor-pointer">
            {" "}
            APPLE{" "}
          </li>
        </HtmlTooltip>
      ...
      <div className="flex items-center text-white absolute ml-[270px] lg:ml-[650px]">
        ...
        <HtmlTooltip
          title={
            <React.Fragment>
              <div className="list-none text-center lg:text-[16px] bg-white">
                <li> PC </li>
                <li> Linh kiện </li>
                <li> Màn hình </li>
                <li> Xây dựng PC </li>
      ...
      <div className="flex items-center text-white absolute ml-[810px] opacity-0 lg:opacity-100">
        <li className="cursor-pointer">
          {" "}
          <FaHeadphones />{" "}
        </li>
      ...
      <div className="flex items-center text-white absolute ml-[930px] opacity-0 lg:opacity-100">
        <li className="cursor-pointer">
          {" "}
          <FaArrowRight />{" "}
        </li>
      ...
      <div className="flex items-center text-white absolute ml-[1088px] opacity-0 lg:opacity-100">
        <li className="cursor-pointer">
          {" "}
          <FaHouseUser />{" "}
        </li>
      ...
      <div className="flex items-center text-white absolute ml-[1260px] opacity-0 lg:opacity-100">
        <li className="cursor-pointer">
          {" "}
          <FaSimCard />{" "}
        </li>
      ...
      <div className="flex items-center text-white absolute ml-[1390px] opacity-0 lg:opacity-100">
        <li className="cursor-pointer">
          {" "}
          <FaStar />{" "}
        </li>
      ...
      <div className="flex items-center text-white absolute ml-[1535px] opacity-0 lg:opacity-100">
        <li className="cursor-pointer">
          {" "}
          <FaPercent />{" "}
        </li>
