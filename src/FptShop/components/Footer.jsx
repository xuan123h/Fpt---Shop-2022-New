...
const Footer = () => {
  return (
    <div className="relative flex items-center list-none lg:mt-[2130px] lg:ml-[331px] lg:h-[283px] border border-white bg-white lg:w-[1276px] flex-wrap w-[370px]">
      <div className="absolute lg:top-[50px] lg:left-[15px] text-orange-700 text-[14px] lg:w-[350px] ml-[70px]">
      ...
      <div className="absolute top-[50px] left-[290px] text-[#3399D2] text-[14px] opacity-0 lg:opacity-100">
      ...
      <div className="absolute top-[50px] left-[510px] text-green-600 text-[14px] opacity-0 lg:opacity-100">
      ...
      <div className="absolute top-[50px] left-[710px] opacity-0 lg:opacity-100">
      ...
      <div className="absolute top-[50px] left-[950px] opacity-0 lg:opacity-100">
        <li className="text-[#4A4A4A] text-[15px]">
          {" "}
      ...
      <p className="lg:mt-[410px] lg:w-[1886px] lg:h-[35px] text-[10px] font-medium text-purple-900 cursor-pointer transition-all w-[600px] ml-2 mt-80">
        {" "}
